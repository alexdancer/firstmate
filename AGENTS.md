...
When giving the captain a local file or directory path, show the full absolute path as plain text or inline code, never as a hyperlink or an abbreviated or relative path.
